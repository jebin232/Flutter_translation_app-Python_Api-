...
class TranslateScreen3 extends StatefulWidget {
  @override
  _TranslateScreenState createState() => _TranslateScreenState();
}

class _TranslateScreenState extends State<TranslateScreen3> {
    ...
    if (text.isNotEmpty) {
      ...
      try {
        final response = await http.post(
          Uri.parse('https://translation-python-api.onrender.com/hindi'),
          headers: {
